...
def load_data(source_list, target_list, batch_size, num_workers, task = 'single'):
    ...
    train_t_dataset = officehome('train_t', train_transform(),target_transform=Onehot(), target_train=True)
...
class officehome(Dataset):
    ...
    def init(source_list, target_list, task):
        ...
        if task == 'single':
            ...
            officehome.TRAIN_T_DATA = target_data[retrieval_t_index]
            officehome.TRAIN_T_TARGETS = target_label[retrieval_t_index]

            officehome.RETRIEVAL_DATA = target_data[retrieval_t_index]
            officehome.RETRIEVAL_TARGETS = target_label[retrieval_t_index]
